...
GetObjectFieldOwnership::GetObjectFieldOwnership(size_t target_register, size_t result_register, size_t using_type_index, const string& field_name, size_t field_index, OwnershipOrder ownership_order) {
...
void GetObjectFieldOwnership::eval(void* vm_thread, void* module, uint64_t* registers, uint64_t* variables, uint64_t* arguments) {
    ...
    while (true) {
        ...
        field_object = (HeapObject*) fields[this->field_index];
...
void GetObjectFieldOwnership::link(void* module, void* function) {
