...
private:
    ...
    SetObjectFieldOwnership(size_t target_register, size_t result_register, size_t using_type_index, const string& field_name, size_t field_index, OwnershipOrder ownership_order);
