...
class GetObjectFieldOwnershipAtomic : public Order {
private:
    ...
    GetObjectFieldOwnershipAtomic(size_t target_register, size_t result_register, size_t using_type_index, const string& field_name);
