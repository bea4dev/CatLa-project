...
GetObjectFieldAtomic::GetObjectFieldAtomic(size_t target_register, size_t result_register, size_t using_type_index, const string& field_name) {
...
void GetObjectFieldAtomic::eval(void* vm_thread, void* module, uint64_t* registers, uint64_t* variables, uint64_t* arguments) {
...
void GetObjectFieldAtomic::link(void* module, void* function) {
